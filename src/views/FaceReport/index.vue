	...
	<div class="report">
        ...
        <div class="top" :style="{ 'z-index': 99}">
          <div class="hand-img">
            <i class="icon_yuan"></i>
            <div class="img-radio">
              <img src="../../assets/images02/photograph/timg01.png" alt />
            </div>
          </div>
	...
	export default {
		data() {
			return {
				...
				top_img: require('../../assets/images02/photograph/timg01.png'),
				attribute: '海王',
...
<style lang="scss" scoped>
	.report {
		...
		.top {
			...
			// }
			.redio {
				background: url("../../assets/images02/photograph/beijing001.png") no-repeat;
				display: block;
				background-size: 100%;
				height: 90px;
				width: 100%;
			...
			.icon {
				background: url("../../assets/images02/photograph/ic_logo2.png") no-repeat;
				background-size: 100%;
				display: block;
				width: 20px;
				height: 20px;
		...
		.container {
			...
			.assessment {
				.info {
					...
					.icon {
						...
						width: 20px;
						height: 20px;
						background: url("../../assets/images02/photograph/dialogue.png") no-repeat;
						background-size: 100%;
			...
			.footer-content {
				...
				.top {
					background: url("../../assets/images02/photograph/buwei_01.png") no-repeat;
					background-size: 100%;
					height: 477px;
					margin: 0 auto;
					...
					.hand-img {
						...
						.icon_yuan {
							...
							height: 230px;
							z-index: 3;
							background: url("../../assets/images02/photograph/tx_yuan.png") no-repeat;
							background-size: 100%;
						}
					}
				...
				.footer-middle {
					...
					.bg_img {
						background: url("../../assets/images02/photograph/buwei_02.png") no-repeat;
						background-size: 100%;
						height: 477px;
						padding: 0 59px 0 37px;
					}
				...
				.footer {
					...
					.code {
						...
						i {
							display: inline-block;
							background: url("../../assets/images02/photograph/kuang_code.png") no-repeat;
							background-size: 100%;
							width: 230px;
							height: 230px;
							position: absolute;
